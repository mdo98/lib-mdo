...
###################################################
### code chunk number 1: parallel.Rnw:460-461 (eval = FALSE)
###################################################
## library(parallel)


###################################################
### code chunk number 2: parallel.Rnw:486-493 (eval = FALSE)
###################################################
## library(boot)
...
###################################################
### code chunk number 3: parallel.Rnw:498-508 (eval = FALSE)
###################################################
## cd4.rg <- function(data, mle) MASS::mvrnorm(nrow(data), mle$m, mle$v)
## cd4.mle <- list(m = colMeans(cd4), v = var(cd4))
...
###################################################
### code chunk number 4: parallel.Rnw:513-514 (eval = FALSE)
###################################################
## do.call(c, lapply(seq_len(mc), run1))


###################################################
### code chunk number 5: parallel.Rnw:518-533 (eval = FALSE)
###################################################
## run1 <- function(...) {
##    library(boot)
##    cd4.rg <- function(data, mle) MASS::mvrnorm(nrow(data), mle$m, mle$v)
...
###################################################
### code chunk number 6: parallel.Rnw:543-556 (eval = FALSE)
###################################################
## cl <- makeCluster(mc)
## cd4.rg <- function(data, mle) MASS::mvrnorm(nrow(data), mle$m, mle$v)
## cd4.mle <- list(m = colMeans(cd4), v = var(cd4))
...
###################################################
### code chunk number 7: parallel.Rnw:561-575 (eval = FALSE)
###################################################
...
###################################################
### code chunk number 8: parallel.Rnw:580-588 (eval = FALSE)
###################################################
## mc <- 9
...
###################################################
### code chunk number 9: parallel.Rnw:602-613 (eval = FALSE)
###################################################
## library(spatial)
...
###################################################
### code chunk number 10: parallel.Rnw:617-626 (eval = FALSE)
###################################################
## run3 <- function(c) {
##     library(spatial)
...
###################################################
### code chunk number 11: parallel.Rnw:630-634 (eval = FALSE)
###################################################
...
###################################################
### code chunk number 12: parallel.Rnw:637-639 (eval = FALSE)
###################################################
## run4 <- function(c)  mean(replicate(R, tget(Strauss(69, c=c, r=3.5))))
...
###################################################
### code chunk number 13: parallel.Rnw:670-704 (eval = FALSE)
###################################################
...
###################################################
### code chunk number 14: parallel.Rnw:717-734 (eval = FALSE)
###################################################
...
###################################################
### code chunk number 15: parallel.Rnw:737-738 (eval = FALSE)
###################################################
##             list(...) # evaluate any promises
