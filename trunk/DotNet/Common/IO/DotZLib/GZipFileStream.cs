...
namespace Zlib.DotZLib
{
	...
	public class GZipFileStream : Stream
	{
        ...
        #region Constructors
        /// <summary>
        /// Creates a new file as a writeable GZipFileStream
        /// </summary>
        /// <param name="fileName">The name of the compressed file to create</param>
        /// <param name="level">The compression level to use when adding data</param>
        /// <exception cref="ZLibException">If an error occurred in the internal zlib function</exception>
		public GZipFileStream(string fileName, CompressLevel level)
		{
            _isWriting = true;
        ...
        /// <exception cref="ZLibException">If an error occurred in the internal zlib function</exception>
        public GZipFileStream(string fileName)
        {
            _isWriting = false;
        ...
        public override int Read(byte[] buffer, int offset, int count)
        {
            ...
            if (_isDisposed) throw new ObjectDisposedException("GZipFileStream");
